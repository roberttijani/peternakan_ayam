	          ...
	          <div class="col-md-8 mx-auto">
	            <div class="form-group row showcase_row_area">
	              ...
	              <div class="col-md-9 showcase_content_area">
	                <input type="text" class="form-control disable" id="inputType1" value="{{ $suplier->nama }}" disabled="">
	              </div>
	            </div>
	            <div class="form-group row showcase_row_area">
	              <div class="col-md-3 showcase_text_area">
	              ...
	              <div class="col-md-9 showcase_content_area">
	                <input type="text" class="form-control disable" id="inputType1" value="{{ $suplier->no_hp }}" disabled="">
	              </div>
	            </div>
	            <div class="form-group row showcase_row_area">
	              <div class="col-md-3 showcase_text_area">
	            ...
	            <div class="form-group row showcase_row_area">
	            	...
	            	<div class="my-3 col-md-9 showcase_content_area">
	            		<a href="{{ route('suplier.index') }}" class="btn btn-rounded btn-primary">Kembali</a>
	            	</div>
	            </div>
	          </div>
	        </div>
